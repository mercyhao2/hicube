...
public class XListViewHeader extends LinearLayout {
   ...
   */
  public void setSpKeyRefreshTime(String spKeyRefreshTime) {
  ...
  private void initView(Context context) {
    ...
    mContentTextView = (TextView) findViewById(R.id.xlistview_header_time);
  ...
  public void showRefreshTime() {
    ...
    if (!TextUtils.isEmpty(spKeyRefreshTime)) {
      SharedPreferences s = getContext().getSharedPreferences(
              XListView.SP_NAME_XLISTVIEW, 0);
      refreshTime = s.getString(spKeyRefreshTime, "刚刚");

    }
    mContentTextView.setText(refreshTime);
  }
